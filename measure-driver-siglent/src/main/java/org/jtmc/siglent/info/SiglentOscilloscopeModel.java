...
/**
 * SiglentOscilloscopeInfo is used to contain meta information about Siglent Oscilloscopes
 */
public class SiglentOscilloscopeModel {
	
	public final static Pattern SCOPE_REGEX = Pattern.compile("SDS(?<seriesprefix>[123456])(?<bandwidth>[0-9]{2})(?<channels>[24])(?<seriespostfix>DL\\+|CML\\+|CFL|X(\\+|-E)?)");
	...
	/**
	 * Returns the bandwidth of the Oscilloscope model
	 * @return
	 */
	public double getBandwidth() {
		...
		throw new IllegalArgumentException("Unable to determine bandwidth from: " + this.bandwidth + "(series " + this.series + ")");
	}
