...
import static org.jtmc.core.util.Units.micro;
import static org.jtmc.core.util.Units.milli;

import org.jtmc.core.signal.CompositeSignal;
import org.jtmc.core.signal.Signal;

/**
 * Wiegand is used to create waveforms that emulate RFID card reader outputs.
 */
public class Wiegand extends CompositeSignal<Boolean> {
  ...
  /**
   * Constructs a Wiegand signal using the given Wiegand26 code.
   * 
   * @param value Card code
   */
