 ...
 * 
 * <p>In general the command format: "ROOT:SUB:CMD PARAM1,PARAM2,..."
 */
public final class SCPICommand {
   ...
   * @return Parameter's value, empty if parameter doesn't exist or doesn't have a value
   */
   ...
   * 
   * <p>Method calls can be chained for compact usage
   * 
   * <p>Create command
   ...
   * 
   * <p>Create command with parameters
   * {@code 
   *  SCPICommand.builder().command("C1:BSWV").with("TYPE", "SINE").with("FREQ", 10000).build()
   * }
   */
  public static final class Builder {
    ...
    /**
     * Appends a parameter with a value to the command.
     * 
